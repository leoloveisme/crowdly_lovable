            ...
            {branchesOpen && (
              <div className="bg-white rounded-md shadow-sm border p-4">
                <div className="text-sm">
                  <p>1. Chapter name by sweet melody View // and contribute there if one decides so</p>
                  <p>2. Chapter name by Master B View // and contribute there if one decides so</p>
